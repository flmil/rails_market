...
class TopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create top" do
    assert_difference('Top.count') do
      post tops_url, params: { top: { money: @top.money, name: @top.name, site: @top.site, url: @top.url } }
    end
  ...
  test "should update top" do
    patch top_url(@top), params: { top: { money: @top.money, name: @top.name, site: @top.site, url: @top.url } }
